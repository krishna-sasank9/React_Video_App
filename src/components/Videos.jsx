  ...
  return (
    <Stack direction={['column','row']} h={'100vh'} >
         <VStack w="full" >
            ...
            <Text>Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque aliquid, delectus voluptatibus quasi voluptate facere unde excepturi harum vel in tempore magnam impedit id similique quos numquam odio ad officia!</Text>
            </VStack>
         </VStack>
